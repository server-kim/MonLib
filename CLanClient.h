#ifndef __LAN_CLIENT_HEADER__
#define __LAN_CLIENT_HEADER__
...
namespace MonLib
{
    ...
    public:
        ...
        bool Connect(WCHAR *p_IP, USHORT Port, int WorkerThreadCnt, bool Nagle = false);  // OutIP -> 클라이언트도 바인딩해도 된다. / 오픈 IP / 포트 / 워커스레드 수 / 나글옵션
