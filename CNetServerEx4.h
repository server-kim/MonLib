#ifndef __NET_SERVER_EX4_HEADER__
#define __NET_SERVER_EX4_HEADER__
...
namespace MonLib
{
    ...
    public:
        CNetServerEx4(int SessionMax, bool Nagle = false);
        virtual ~CNetServerEx4(void);
