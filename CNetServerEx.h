#ifndef __NET_SERVER_EX_HEADER__
#define __NET_SERVER_EX_HEADER__
...
namespace MonLib
{
    ...
    private:
        ...
        //struct st_ACCEPT_OVERLAPPED
        {
            ...
            //CNetServerEx::st_CLIENT_CONNECT_INFO ClientConnectInfo;
        };

        //struct st_ACCEPT_BUF;
        //
        //struct st_ACCEPT_OVERLAPPED : OVERLAPPED
        //{
        //    st_ACCEPT_BUF *_p_AcceptBuf = nullptr;
        //};
        //
        //struct st_ACCEPT_BUF
        //{
        ...
        //    SOCKET _Sock = INVALID_SOCKET;
        //    BYTE _Buf[(sizeof(sockaddr_in) + 16) * 2];
        //    //OVERLAPPED _AccpetOL;
        //    st_ACCEPT_OVERLAPPED _AcceptOL;
        //};
    ...
    public:
        CNetServerEx(int SessionMax, bool Nagle = false);
        virtual ~CNetServerEx(void);
